/* File-action-menu — global handler shared by file & folder action panels.
   Closes other open menus on trigger click, positions the panel below the
   trigger via CSS vars, supports drag-to-reposition by .fa-head / [data-action-drag-handle].
   Loaded via @once @push('scripts') from partials/file-action-menu-script.blade.php. */
(() => {
